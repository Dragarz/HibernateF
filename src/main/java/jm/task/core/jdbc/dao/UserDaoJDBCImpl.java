...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public void createUsersTable() {
        try(Util util = new Util()){
            util.getStatement().execute("CREATE TABLE `mydbtest`.`users` (`id` INT NOT NULL AUTO_INCREMENT,`name` VARCHAR(45) NOT NULL,`lastname` VARCHAR(45) NOT NULL,`age` INT NOT NULL, PRIMARY KEY (`id`), UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE)");
